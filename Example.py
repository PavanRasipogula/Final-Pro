...
tomato_plant = cv2.imread(
    'C:/Users/justm/AppData/Local/Programs/Python/Python311/Plant-Leaf-Disease-Prediction-main/Dataset/test/Tomato___Bacterial_spot (1).JPG')
